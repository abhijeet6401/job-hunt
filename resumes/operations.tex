...
\section{Operations Projects \& Case Competitions}

\textbf{JobHunt Agent | AI Operations \& Automation | Self Project} \hfill \textbf{\small Jun'26} \\
\textit{\small Full-stack AI automation assistant orchestrating real-time job discovery, resume tailoring, and outreach pipelines}
\begin{achievelist}
  \achieve{Automated multi-channel job extraction across LinkedIn and YC startups via Tavily API, integrating dynamic LaTeX resume compilers.}
  \achieve{Orchestrated real-time application logging and cold-outreach generation via Sheets API, eliminating 10+ manual hours per week.}
\end{achievelist}
